...
{
    public static class HotelMapperWEB
    {
        ...
        static HotelMapperWEB()
        {
           ...
           .ForMember(room => room.Category, opt => opt.Ignore())).CreateMapper();
            ...
            mapperAdministrator = new MapperConfiguration(cfg => cfg.CreateMap<AdministratorDTO, AdministratorModel>().ReverseMap()).CreateMapper();
        }
